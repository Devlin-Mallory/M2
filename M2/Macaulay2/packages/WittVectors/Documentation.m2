...
doc ///
	...
	MaxHeight
    Headline
	Finds the quasi-F-split height ht(S/I) at the origin of the quotient of the polynomial ring S=(ZZ/p)[x1,...,xn] by an ideal I generated by a regular sequence (f1,...,fm).
    Usage
	fSplittingHeight I
    Inputs
	I: Ideal
